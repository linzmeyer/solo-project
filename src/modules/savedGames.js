let savedGames = {
  game1: {
    solution: `ground sloth`,
    reward: `Choose a scavenger hunt item from the prize bucket.`,
    ...
    finalClueHint: `FINAL QUESTION FOR THE REWARD: What extinct animal lived in North America until about 11,000 years ago, stood about 9.8 feet tall, and weighed an estimated 2,205 pounds? President Thomas Jefferson sent Lewis and Clark west looking for giant lions after he learned about a fossil found in Ohio of this mystery animal's claw. Hint: Use the letters you earned in the hunt to unscramble the animal's name.`,
    clue1Answer: `eder`,
